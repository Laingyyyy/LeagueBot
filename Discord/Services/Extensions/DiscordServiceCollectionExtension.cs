...
{
    /// <summary>
    /// Adds Discord-related Repositories to the specified IServiceCollection.
    /// </summary>
    /// <param name="services">The IServiceCollection to which the Discord Repositories will be added.</param>
    /// <returns>The IServiceCollection with the added Discord Repositories.</returns>
